    ...
    <div className="min-h-screen bg-gray-50 py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div>
            ...
            <div className="bg-white p-8 rounded-lg shadow mb-8">
              ...
              <div className="space-y-2">
                <div className="flex justify-between">
                  <span className="text-gray-900">Monday - Thursday</span>
                  <span className="font-medium text-gray-900">11:00 AM - 2:00 AM</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-900">Friday - Saturday</span>
                  <span className="font-medium text-gray-900">11:00 AM - 3:00 AM</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-900">Sunday</span>
                  <span className="font-medium text-gray-900">12:00 PM - 2:00 AM</span>
                </div>
              </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="font-semibold mb-2 text-gray-900">Parking</h3>
                  <p className="text-gray-700">
                    Free street parking available. Valet parking available on weekends.
                  </p>
                </div>
                <div>
                  <h3 className="font-semibold mb-2 text-gray-900">Accessibility</h3>
                  <p className="text-gray-700">
          ...
          <div>
            <div className="bg-white p-8 rounded-lg shadow mb-8">
              ...
              <div className="bg-gray-100 border-2 border-dashed border-gray-300 h-64 rounded-lg flex items-center justify-center mb-4">
                <span className="text-gray-500 font-medium">Interactive Map Coming Soon</span>
              </div>
              <div className="space-y-3 text-sm">
                <p className="text-gray-700"><strong className="text-gray-900">From Downtown Denver:</strong> Head north on Main Street for 2 miles</p>
                <p className="text-gray-700"><strong className="text-gray-900">From I-25:</strong> Exit at Main Street, head east for 1 mile</p>
                <p className="text-gray-700"><strong className="text-gray-900">Public Transit:</strong> Bus routes 15, 20, and 30 stop nearby</p>
              </div>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="font-semibold mb-2 text-gray-900">Atmosphere</h3>
                  <p className="text-gray-700">
                ...
                <div>
                  <h3 className="font-semibold mb-2 text-gray-900">Dress Code</h3>
                  <p className="text-gray-700">
                    Casual attire welcome. No dress code - come as you are!
                  </p>
                </div>
                <div>
                  <h3 className="font-semibold mb-2 text-gray-900">Age Policy</h3>
                  <p className="text-gray-700">
        ...
        <div className="mt-16 text-center">
          <h2 className="text-2xl font-semibold mb-4 text-gray-900">Ready to Visit?</h2>
